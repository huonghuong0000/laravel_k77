                        ...
                        <div class="panel-body">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="is_highlight" class="form-control">
                                            <option @if($product->is_highlight==0) selected @endif value="0">Không</option>
                                            <option @if ($product->is_highlight==1) selected @endif value="1">Có</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Miêu tả</label>
                                        <textarea id="description" name="describe" style="width: 100%;height: 100px;"></textarea>
                                    </div>
