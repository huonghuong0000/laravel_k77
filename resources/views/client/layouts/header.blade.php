...
<div id="page">
                    ...
                    <div class="col-xs-2">
                        <div id="colorlib-logo">
                            <a href="{{ route('client.home.index') }}">
                                <img src="/assets/client/images/logo.png" alt="" style="width: 300px;height: 50px;">
                            </a>
                        </div>
                    </div>
                    <div class="col-xs-10 text-right menu-1">
                        <ul>
                            ...
                            <li class="has-dropdown">
                                <a href="{{ route('client.product.shop') }}">Cửa hàng</a>
                                <ul class="dropdown">
                                    <li><a href="{{ route('client.cart.cart') }}">Giỏ hàng</a></li>
    ...
    <aside id="colorlib-hero">
        <div class="flexslider">
            <ul class="slides">
                <li style="background-image: url(/assets/client/images/bg-03.jpg);">
                ...
                <li style="background-image: url(/assets/client/images/bg-01.jpg);">
                    <div class="overlay"></div>
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6 col-md-offset-3 col-md-pull-2 col-sm-12 col-xs-12 slider-text">
                ...
                <li style="background-image: url(/assets/client/images/bg-02.jpg);">
                    <div class="overlay"></div>
                    <div class="container-fluid">
                        <div class="row">
